 ...
 * INA226
    ...
    SENSOR DE TENSAO E CORRENTE
    TENSAO DA BATERIA E CORRENTE NO MOTOR

    ESCREVENDO SOBRE TENSAO:
    INA RECEBE NO MAXIMO 32 OU 36V... NAO SEI, MAS A BATERIA É 42V, POR ISSO O DIVISOR DE TENSAO COM R5 E R6

    ESCREVENDO SOBRE CORRENTE:
    O SHUNT EH UM RESISTOR DE RESISTENCIA MUITO BAIXA E O INA CALCULA A CORRENTE QUE PASSA POR ELE (QUE EH A CORRENTE DO MOTOR) COM BASE NA 
    QUEDA NA LEI DE OHM E NA QUEDA DE TENSAO DO SHUNT

    SOBRE FATOR DE CORRECAO:
    O INA NAO EH MUITO PRECISO. OS FATORES DE CORRECAO_V E CORRECAO_C SERVEM APENAS PARA CALIBRA-LO
